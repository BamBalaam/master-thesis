...
\section{Aims and objectives of this thesis}
...
their flaws and positive aspects, and define what kind of new parser would be interesting to develop. Using the Python programming language, a set of tools will be created in order to
parse and visualise the structure of given sentences, in order to analyse them.\newline
